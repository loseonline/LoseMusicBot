...
from LoseMusic import app, userbot
from LoseMusic.misc import SUDOERS
from LoseMusic.utils.database import (get_active_chats,
                                       ...
                                       update_user_top)
from LoseMusic.utils.decorators.language import language
from LoseMusic.utils.formatters import alpha_to_int
...
async def braodcast_message(client, message, _):
    ...
    if "-assistant" in message.text:
        ...
        text = _["broad_3"]
        from LoseMusic.core.userbot import assistants

        for num in assistants:
            sent = 0
            client = await get_client(num)
            async for dialog in client.iter_dialogs():
                if dialog.chat.id == -1001726719696:
                    continue
                try:
