...
from LoseMusic.misc import SUDOERS, db
from LoseMusic.utils.database import (is_active_chat,
                                       is_music_playing, is_muted,
                                       is_nonadmin_chat, music_off,
                                       music_on, mute_off, mute_on,
                                       set_loop)
from LozeMusic.utils.decorators.language import languageCB
from LoseMusic.utils.formatters import seconds_to_min
from LoseMusic.utils.inline.play import (panel_markup_1,
                                          panel_markup_2,
                                          panel_markup_3,
                                          stream_markup,
                                          telegram_markup)
